...
@tbl-regression-results summarizes the regression results, showing the estimated coefficients, median absolute deviations, and credible intervals for each predictor.
```{r}
#| label: tbl-regression-results
#| echo: false
#| tbl-cap: "Regression model summary showing that hardcover books and those with 150-299 pages are positively associated with higher ratings, while books published before 2000 tend to receive lower ratings. Credible intervals confirm that these associations are statistically significant."
#| warning: false
#| message: false
