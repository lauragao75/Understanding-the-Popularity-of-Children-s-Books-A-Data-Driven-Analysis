...
Parts of the code were written with the assistance of Chatgpt -4o. Additionally, the abstract, introduction, and parts of the appendix were developed with the help of Chatgpt -4o, and the entire chat history is documented in `other/llm/usage.txt`.
